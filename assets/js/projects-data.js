...
const PROJECTS = [
    {
        id: 'assemblash',
        name: 'Assemblash',
        nameKey: 'projects.assemblash.title',
        description: 'Assemblash is an open-source, local-first visual document engine where people and AI agents work on the same editable document through a web editor, CLI, HTTP API, or MCP.',
        descriptionKey: 'projects.assemblash.desc',
        category: 'AI & Automation',
        categoryKey: 'projects.category.ai',
        categories: ['AI & Automation', 'Open Source'],
        categoryKeys: ['projects.category.ai', 'projects.category.opensource'],
        tags: ['Rust', 'Web Editor', 'CLI', 'HTTP API', 'MCP', 'Editable Documents', 'Open Source'],
        icon: 'layers',
        iconImage: 'assets/img/projects/assemblash/assemblash-mark.svg',
        status: 'released',
        statusKey: 'projects.status.released',
        dateCompleted: '2026-09-05',
        lastUpdated: '2026-09-12',
        githubUrl: 'https://github.com/VidGuiCode/assemblash',
        link: 'projects/project-assemblash',
        featured: true,
        priority: 1
    },
    {
        ...
        description: 'My own platform for files, media, custom apps, and AI agents, spread across four connected nodes.',
        ...
        icon: 'server-cog',
        status: 'maintained',
        statusKey: 'projects.status.maintained',
        milestoneDate: '2025-03',
        dateStarted: '2025-03',
    ...
    },
    {
        ...
        description: 'Cylro is a website operations platform in development for teams managing multiple websites, access, content, and publishing from one organised Space.',
        ...
        tags: ['Website Operations', 'Multi-site', 'Structured Editing', 'Controlled Publishing', 'Role-based Access', 'Nuxt', 'Vue', 'Node.js', 'Express', 'PostgreSQL', 'Docker'],
        icon: 'layout',
        iconImage: 'assets/img/projects/cylro/cylro-app-icon-brand.svg',
    ...
    },
    {
        ...
        description: 'My big final project for my Computer Technician diploma (September 2024 – June 2025). I built a complete IoT system with ESP8266 sensor nodes, a Raspberry Pi hub, a web dashboard to monitor everything, enterprise networking with VLANs, and automated backups. Presented the whole thing and got 59/60.',
    ...
    },
    {
        ...
        description: 'A self-hosted AI agent running 24/7 on its own VPS - Matrix-first messaging, voice in and out, persistent memory, scheduled automation, deep research and homelab watchdogs, all in one conversation.',
    ...
    },
    {
        ...
        description: 'Desktop app that records meetings, transcribes locally or through a transcription API, and generates AI summaries with cloud or local models. Local-first, with separate live captions and versioned transcripts.',
        ...
        tags: ['Electron', 'Node.js', 'Python', 'faster-whisper', 'whisper.cpp', 'Groq', 'OpenAI', 'Mistral', 'Anthropic', 'Ollama', 'FFmpeg', 'AI', 'Transcription', 'Speech-to-Text', 'Local-First'],
        icon: 'audio-waveform',
    ...
    },
    {
        ...
        tags: ['TypeScript', 'Node.js', 'CLI', 'Azure', 'Azure CLI', 'ARM REST', 'Regions', 'VM SKUs', 'Quota', 'Azure Policy', 'Resource Availability', 'Pricing', 'CI', 'Open Source', 'Commander.js', 'Vitest'],
        icon: 'map-pin',
        status: 'completed',
        statusKey: 'projects.status.completed',
    ...
    },
    {
        ...
        tags: ['Python', 'argparse', 'uv', 'CLI', 'Infomaniak', 'kSuite', 'kDrive', 'kChat', 'Mail', 'IMAP', 'CardDAV', 'CalDAV', 'Mattermost', 'REST API', 'AI Agents', 'Open Source'],
        icon: 'cloud',
        status: 'completed',
        statusKey: 'projects.status.completed',
        dateCompleted: '2026-06',
    ...
    },
    {
        ...
        description: 'A lightweight TUI system monitor for Linux with real-time graphs, Docker and Kubernetes monitoring, security log analysis, and 5 built-in themes. Optimized for low-power devices like Raspberry Pi.',
    ...
    },
    {
        ...
        description: 'A school project (November 2025 – January 2026) built with Power Platform after a teacher mentioned how much work it was to send messages to 20+ Teams channels manually. It gets old really fast. This tool lets you select all your channels at once, write your message once, and send it everywhere with a single click. It\'s designed for teachers managing hundreds of class channels and anyone else who\'s tired of copy-pasting announcements over and over.',
    ...
    },
    {
        ...
        description: 'A group project (October – November 2025) where we built a grade management system with Django. Teachers grade students in their own courses and add comments, students can track their progress. We delivered an MVP and I learned some valuable lessons about choosing the right framework for the job.',
    ...
    },
    {
        ...
        description: 'My two-person team documented and demonstrated a Windows Server 2022 Remote Desktop Services deployment. It combines AD DS, DNS, RD Web Access, and a session-based collection so students can securely access a shared desktop from external Windows 11 clients.',
